...
const $anyscalar: $anyscalar = $.makeType<$anyscalar>(_.spec, "45de2bf0-950a-11ec-9330-774e5189fb01", _.syntax.literal);

type $anyreal = $anyint | $anyfloat | $anynumeric;
const $anyreal: $anyreal = $.makeType<$anyreal>(_.spec, "45e4246a-950a-11ec-9ab8-a708f0c7ff98", _.syntax.literal);

type $anyfloat = $number;
const $anyfloat: $anyfloat = $.makeType<$anyfloat>(_.spec, "45e81eda-950a-11ec-8351-b9ae6898947c", _.syntax.literal);

type $anyint = $number | $bigint;
const $anyint: $anyint = $.makeType<$anyint>(_.spec, "45e4eefe-950a-11ec-9130-8730a7435923", _.syntax.literal);

type $anynumeric = $decimal | $bigint;
const $anynumeric: $anynumeric = $.makeType<$anynumeric>(_.spec, "45ea667c-950a-11ec-a1bf-47432f7d23de", _.syntax.literal);
...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "45ecc232-950a-11ec-8325-d7d891782612", _.syntax.literal);
...
export type $BaseObjectλShape = $.typeutil.flatten<{
  "id": $.PropertyDesc<$uuid, $.Cardinality.One, true, false, true>;
  "__type__": $.LinkDesc<_schema.$Type, $.Cardinality.One, {}, false, false, false>;
}>;
type $BaseObject = $.ObjectType<"std::BaseObject", $BaseObjectλShape, null>;
const $BaseObject = $.makeType<$BaseObject>(_.spec, "4d3e9d26-950a-11ec-b585-93c4230133c2", _.syntax.literal);
...
export type $Object_4d45d5f0950a11ecba09dfe7f1d24c40λShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_4d45d5f0950a11ecba09dfe7f1d24c40 = $.ObjectType<"std::Object", $Object_4d45d5f0950a11ecba09dfe7f1d24c40λShape, null>;
export type $Object = $Object_4d45d5f0950a11ecba09dfe7f1d24c40
const $Object_4d45d5f0950a11ecba09dfe7f1d24c40 = $.makeType<$Object_4d45d5f0950a11ecba09dfe7f1d24c40>(_.spec, "4d45d5f0-950a-11ec-ba09-dfe7f1d24c40", _.syntax.literal);

const Object_4d45d5f0950a11ecba09dfe7f1d24c40: $.$expr_PathNode<$.TypeSet<$Object_4d45d5f0950a11ecba09dfe7f1d24c40, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Object_4d45d5f0950a11ecba09dfe7f1d24c40, $.Cardinality.Many), null, true);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "4d4db694-950a-11ec-9f72-43be393c6b69", _.syntax.literal);
...
function min(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "45e4246a-950a-11ec-9ab8-a708f0c7ff98", optional: false, setoftype: true, variadic: false}], returnTypeId: "45e4246a-950a-11ec-9ab8-a708f0c7ff98", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "45ed93b0-950a-11ec-bbda-55ea5b9be7f5", optional: false, setoftype: true, variadic: false}], returnTypeId: "45ed93b0-950a-11ec-bbda-55ea5b9be7f5", returnTypemod: "OptionalType", preservesOptionality: true},
...
function sequence_reset(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "5123518e-950a-11ec-bc61-25ca3c301fc8", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "5123518e-950a-11ec-bc61-25ca3c301fc8", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { $anyscalar, $anyreal, $anyfloat, $anyint, $anynumeric, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_4d45d5f0950a11ecba09dfe7f1d24c40, Object_4d45d5f0950a11ecba09dfe7f1d24c40, $FreeObject, FreeObject };
...
type __defaultExports = {
  ...
  "Object": typeof Object_4d45d5f0950a11ecba09dfe7f1d24c40;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_4d45d5f0950a11ecba09dfe7f1d24c40,
